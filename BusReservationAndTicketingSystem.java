...
public class BusReservationAndTicketingSystem {
    ...
    public static void main(String args[]) throws IOException {
        ...
        for(int i=1;i<4;){
            System.out.print("Enter Username (enter username as 1): ");
            user = in.readLine();
            System.out.print("Enter Password:(enter password as 1) ");
            ...
            if(user.equals("1") && password.equals("1")){
                ...
                for(int x=1; x==1;){
                   ...
                   // System.out.println("** BUS RESERVATION AND TICKETING SYSTEM   **");
                    ...
                    for(x=1; x==1;){
                        System.out.print("ENTER CHOICE: (1 for displaying the destination / 2 for ticket booking) ");
                        choice=in.readLine();
                        ...
                        if (choice.equals("1")){
                            ...
                            System.out.println("***************************************");
                            System.out.println("** 1.)JALANDHAR    | 600 |   "+available[1]+"   **");
                            System.out.println("** 2.)DELHI        | 170 |   "+available[2]+"   **");
                            System.out.println("** 3.)GURGAON      | 150 |   "+available[3]+"   **");
                            System.out.println("** 4.)NOIDA        | 200 |   "+available[4]+"   **");
                            System.out.println("** 5.)AHMEDABAD    | 250 |   "+available[5]+"   **");
                            System.out.println("***************************************");
                            System.out.println("***************************************\n");
